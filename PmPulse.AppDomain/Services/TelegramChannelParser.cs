...
using PmPulse.AppDomain.Models.Telegram;
using System;
...
{
    public static class TelegramChannelParser
    {
        ...
        public static async Task<TelegramChannel> ParseChannelAsync(string channelName, bool onlyText = false, int limit = 100)
        {
            ...
            var messageNodes = doc.DocumentNode.QuerySelectorAll(TelegramMessageClass);
